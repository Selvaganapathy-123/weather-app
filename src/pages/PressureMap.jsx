...
const PressureMap = () => {
  ...
  const pressureLayerUrl = `https://tile.openweathermap.org/map/pressure_new/{z}/{x}/{y}.png?appid=${apiKey}`;
  ...
  return (
    <div>
      ...
      <h1 style={{ textAlign: 'center' }}>Pressure Map</h1>
